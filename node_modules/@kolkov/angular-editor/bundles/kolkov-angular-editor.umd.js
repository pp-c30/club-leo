    ...
    ***************************************************************************** */
    ...
    var AngularEditorToolbarComponent = /** @class */ (function () {
        ...
        AngularEditorToolbarComponent.propDecorators = {
            ...
            fonts: [{ type: core.Input }],
            customClasses: [{ type: core.Input }],
            defaultFontName: [{ type: core.Input }],
            defaultFontSize: [{ type: core.Input }],
            hiddenButtons: [{ type: core.Input }],
            execute: [{ type: core.Output }],
            myInputFile: [{ type: core.ViewChild, args: ['fileInput', { static: true },] }]
        };
    ...
    var AngularEditorComponent = /** @class */ (function () {
        ...
        AngularEditorComponent.propDecorators = {
            ...
            textArea: [{ type: core.ViewChild, args: ['editor', { static: true },] }],
            editorWrapper: [{ type: core.ViewChild, args: ['editorWrapper', { static: true },] }],
            editorToolbar: [{ type: core.ViewChild, args: ['editorToolbar', { static: false },] }],
    ...
    var AeSelectComponent = /** @class */ (function () {
        ...
        AeSelectComponent.propDecorators = {
            ...
            isHidden: [{ type: core.Input, args: ['hidden',] }],
            hidden: [{ type: core.HostBinding, args: ['style.display',] }],
            changeEvent: [{ type: core.Output, args: ['change',] }],
            labelButton: [{ type: core.ViewChild, args: ['labelButton', { static: true },] }],
